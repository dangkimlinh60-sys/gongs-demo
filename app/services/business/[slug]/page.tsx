  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20">
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-800 mb-8">办理流程</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {service.process.map((step, index) => (
                <div key={index} className="relative">
                  ...
                  <div className="h-1 bg-red-100 rounded"></div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-8 bg-blue-50 border-l-4 border-blue-600 p-6 rounded">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 text-lg">办理时间</h3>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-red-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8">专业团队为您提供一对一服务</p>
